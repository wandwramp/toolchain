...
int main(int argc, char *argv[])
{
	...
	cout << "File name: " << file[0].filename << endl;

	cout << "Magic Number:   0x" << setw(8) << setfill(' ') << hex << file[0].file_header.magic_number           << endl;
	cout << "Text size:      0x" << setw(8) << setfill(' ') << hex << file[0].file_header.text_seg_size          << endl;
	cout << "Data Size:      0x" << setw(8) << setfill(' ') << hex << file[0].file_header.data_seg_size          << endl;
	cout << "Bss Size:       0x" << setw(8) << setfill(' ') << hex << file[0].file_header.bss_seg_size           << endl;
	cout << "Num references: 0x" << setw(8) << setfill(' ') << hex << file[0].file_header.num_references         << endl;
	cout << "Table size:     0x" << setw(8) << setfill(' ') << hex << file[0].file_header.symbol_name_table_size << endl;

	// for(unsigned int i = 0; i < file[0].file_header.text_seg_size; i++){
	// 	cout << "\t";
	// 	disassemble(i,file[0].segment[TEXT][i]);
	// 	cout << endl;
	// }

	// for(unsigned int i = 0; i < file[0].file_header.data_seg_size; i++){
	// 	cout << "\t0x" << setw(8) << setfill(' ') << hex << file[0].segment[DATA][i] << endl;
	// }
